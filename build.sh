...
REACT_APP_SERVER_URL=${REACT_APP_SERVER_URL:-https://suzz-project-5.onrender.com} REACT_APP_APP_NAME=${REACT_APP_APP_NAME:-Secure Chat App} PUBLIC_URL=. npx react-scripts build
