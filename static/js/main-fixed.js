// Modern JavaScript for Suzu Customer Interface - Fixed Version
class SuzuApp {
    constructor() {
    ...
    validatePhoneInput(input) {
        ...
        if (phone.length > 0) {
            ...
            if (isValid) {
                ...
                this.showError('phone-error', 'رقم الهاتف غير صالح');
            }
        }
    }
    ...
    async handleRegistration() {
        ...
        if (!this.isValidEgyptianPhone(phone)) {
            this.showError('phone-error', 'رقم الهاتف غير صالح. يجب أن يكون 11 رقم ويبدأ بـ 01');
            phoneInput.classList.add('border-red-500', 'error-shake');
            setTimeout(() => phoneInput.classList.remove('error-shake'), 500);
            phoneInput.focus();
            return;
